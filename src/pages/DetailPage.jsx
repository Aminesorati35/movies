...
import { Back, Play, Star } from "../components/icons/Icons";
      ...
      <div className="min-h-screen bg-[#050510] text-white flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <button
            type="button"
            onClick={() => navigate("/")}
            className="bg-indigo-600 hover:bg-indigo-500 px-5 py-3 rounded-xl font-semibold cursor-pointer"
          >
            Back Home
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#050510] relative">
      ...
      <div className="relative w-full pt-20 px-3 md:px-6">
        <div className="relative w-[100%] max-w-7xl mx-auto overflow-hidden rounded-2xl border border-blue-400/40 bg-black before:pointer-events-none">
