    ...
    <div className="min-h-screen bg-[#050510]">
      ...
      <div className="relative h-[62vh] min-h-[380px]">
        ...
        <div
          className="absolute inset-0"
          style={{
            background: "linear-gradient(to right, #050510 0%, transparent 55%)",
          }}
        />
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          >
            <div
              className="w-20 h-20 md:w-24 md:h-24 rounded-full flex items-center justify-center border-2 border-white/20 transition-all duration-300 group-hover:scale-104 pl-1"
              style={{
      ...
      <div className="px-6 md:px-14 -mt-32 relative z-10 pb-20">
        <div className="flex flex-col md:flex-row gap-8 mb-12">
          ...
          <div className="flex-1 pt-2 text-center md:text-left">
            ...
            <button
              onClick={onPlay}
              className="inline-flex items-center gap-3 text-white font-semibold px-8 py-4 rounded-2xl transition-all text-base hover:scale-102 cursor-pointer"
              style={{
